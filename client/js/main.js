...
(function () {
	...
	var cs, tmpFolderPath, imageCanvas, loader, loaderCover, imagePanArea, originalFileSize, saveImageBut, currentImageSelected = '', customColourInput, dialog, greyOut;
	var fs = require('fs');
	...
	function init() {
		...
		var saveB64But = document.querySelector('#saveBase64But');
		saveB64But.addEventListener('click', onSaveB64Clicked, false);
		dialog = document.querySelector('.base-64-dialog');
		greyOut = document.querySelector('.grey-out');
		var dialogCloseBut = document.querySelector('.dialog-close');
		dialogCloseBut.addEventListener('click', onDialogCloseClicked, false);
